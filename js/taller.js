...
function renderResultSquare(r, calc) {
  ...
  overlay.style.color = 'lightslategray';
  ...
  resultIMG.src = 'assets/images/square.png';
...
function renderResultCube(r, calc) {
  ...
  resultIMG.src = 'assets/images/cube.png';
...
function renderResultCircle(r, calc) {
  ...
  resultIMG.src = 'assets/images/circle.png';
...
function renderResultTriangles(r, calc) {
  ...
  resultIMG.src = 'assets/images/triangle.png';
